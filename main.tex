...
\supervisor{Фильченков Андрей Александрович}{Фильченков А.А.}{к.ф-м.н., доцент кафедры компьютерных технологий}{}
\publishyear{2017}
...
\advancedtechnologyusage{
    Были использованы язык программирования Python, интегрированная среда разработки PyCharm, 
    фрэймворк для символьных вычислений Tensorflow,
